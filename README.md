...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/analysisstore-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14865&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/analysisstore-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `analysisstore` can be installed with:

```
conda install analysisstore
```

It is possible to list all of the versions of `analysisstore` available on your platform with:
